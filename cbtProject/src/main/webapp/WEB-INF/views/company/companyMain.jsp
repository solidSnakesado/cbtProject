...
<div id="carouselExampleInterval" class="carousel slide carousel-fade"
	...
	<div class="carousel-inner">
		<div class="carousel-item active" data-interval="4000">
			<img src="${pageContext.request.contextPath}/image/systemintro.png"
				class="d-block w-100" alt="오케이">
		</div>
		<div class="carousel-item" data-interval="4000">
			<img src="${pageContext.request.contextPath}/image/company.jpg"
				class="d-block w-100" alt="빨리끝나자">
		</div>
		<div class="carousel-item" data-interval="4000">
			<img src="${pageContext.request.contextPath}/image/main.PNG"
				class="d-block w-100" alt="안뇽">
		</div>
	</div>
