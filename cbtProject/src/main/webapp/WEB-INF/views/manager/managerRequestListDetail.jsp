...
<h2>관리자 기업의뢰목록 세부</h2>
	의뢰일: <input type="text" value="19/06/17" readonly><br>
	금액: <input type="text" value= 500000원><br>
	진행상태: <select >
	...
	응시자수 : <input type="text" value=50 readonly="readonly"><br>
	난이도: <select >
	...
	시험일시: <input type="text" value="19/07/11"><br>
	시험분류: <select >
	...
	합격점수: <input type="text" value=60><br>
	시험명: <input type="text" value="정보처리기사"><br>
	시험시간: <select >
	    <option value="">0:45:00</option>
	    <option value="">1:00:00</option>
	    <option value="">1:30:00</option>
			</select><br>
	문항수: <input type="text" value=50><br>
	응시가능횟수 <select >
	...
	<br>
	<button type="button" onclick="location.href='request_list_admin.html'">확인</button>
	 <button type="button" onclick="location.href='request_list_admin.html'">수정</button> 
	 <button type="button" onclick="location.href='request_list_admin.html'">삭제</button>
</body>
</html>