...
<table border="1">
   ...
   <tr onclick="location.href='managerConsultingListDetailAdmin.html'">
      <td>AMAZON</td>
      <td>아마존</td>
      <td>제프 베조스</td>
      <td>2020.06.20 
   ...
   <tr>
      <td onclick="location.href='managerConsultingListDetailAdmin.html'">MS</td>
      <td>마이크로소프트</td>
      <td>빌게이츠</td>
      <td>2020.06.20 
		15:00 ~ 18:00</td>
   ...
   <tr>
      <td onclick="location.href='managerConsultingListDetailAdmin.html'">APPLE</td>
      <td>애플</td>
      <td>팀 쿡</td>
      <td>2020.06.20 
		15:00 ~ 18:00</td>
