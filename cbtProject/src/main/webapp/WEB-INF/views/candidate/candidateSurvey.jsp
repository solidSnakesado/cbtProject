...
-->
	...
	<form id="fmField" name="fmField" action="insertSurvey.do" method="POST">
	<input type="hidden" name="surveyType" value="1"/>
	<input type="hidden" name="takeExamId" value="${takeExamVO.takeExamId}"/>
			...
			<tr>
				...
				<td>
					...
					<br>
						...
						<tr>
				<td>
					<h4 align="Left">7. 이 시험으로 인해 얻고자하는 기대효과는 무엇입니까?</h4><br>
					<p align="Left">
