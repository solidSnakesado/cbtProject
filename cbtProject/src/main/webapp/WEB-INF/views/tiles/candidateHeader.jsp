...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="candidateScheduleCheck.do" class="w3-bar-item w3-button w3-padding-large w3-hide-small">회사소개</a>
    <!-- 2019.07.09 성재민 -->
    <!-- 시험일정 메뉴 연결 -->
    <a href="candidateScheduleCheck.do/${candidate.takerId}" class="w3-bar-item w3-button w3-padding-large w3-hide-small">시험일정</a>
