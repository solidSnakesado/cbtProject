...
public class SendEmailService {
	...
	public void send(EmailVO vo) {
		...
		final String username = "freehwans@gmail.com"; // change accordingly
		final String password = "mvahjgubpnfqxuob"; // change accordingly
	...
	public void sendAttatch(EmailVO vo) {
		String to = vo.getTo();// change accordingly
		String from = vo.getFrom(); // change accordingly
		final String username = "cyanthin@gmail.com"; // change accordingly
		final String password = "앱비밀번호"; // change accordingly
