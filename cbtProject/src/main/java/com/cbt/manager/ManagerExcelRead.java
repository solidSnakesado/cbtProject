...
public class ManagerExcelRead {
	 public static List<Map<String, String>> read(ManagerExcelReadOption excelReadOption) {
         ...
         Workbook wb = ManagerExcelFileType.getWorkbook(excelReadOption.getFilePath());
         ...
         for(int i =0; i<sheetNum; i++){
             ...
             if(row != null) {
                 ...
                 for(int cellIndex = 0; cellIndex < numOfCells; cellIndex++) {
                      ...
                      * 이름의 예 : A,B,C,D,......
                      */
                     cellName = ManagerExcelCellRef.getName(cell, cellIndex);
                     /*
                      * 추출 대상 컬럼인지 확인한다
                      * 추출 대상 컬럼이 아니라면, 
                      * for로 다시 올라간다
                      ...
                      */
                     map.put(cellName, ManagerExcelCellRef.getValue(cell));
                 }
                 /*
